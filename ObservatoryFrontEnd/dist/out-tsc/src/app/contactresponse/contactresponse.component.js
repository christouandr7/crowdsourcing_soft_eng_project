...
var ContactresponseComponent = /** @class */ (function () {
    ...
    ContactresponseComponent = __decorate([
        Component({
            ...
            templateUrl: './contactresponse.component.html',
            styleUrls: ['./contactresponse.component.scss']
        }),
        __metadata("design:paramtypes", [])
    ], ContactresponseComponent);
    return ContactresponseComponent;
}());
export { ContactresponseComponent };
//# sourceMappingURL=contactresponse.component.js.map